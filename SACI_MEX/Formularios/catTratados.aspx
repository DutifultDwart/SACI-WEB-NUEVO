<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Formularios/Principal.Master" CodeBehind="catTratados.aspx.cs" Inherits="SACI_MEX.Formularios.catTratados" EnableEventValidation="true" ValidateRequest="false" EnableViewStateMac="false" %>
    ...
    <script type="text/javascript">
        ...
        function Valida(s, e) {
            ...
            if (errores) {
                ...
                $('#modalTratado').modal('hide');
                cbpCatTratados.PerformCallback('guardarTratado');
            }
        }

        /*Ajustar el tamaño del grvRef al tamaño de la pantalla */
        function OnInitGridTratados(s, e) {
        ...
        <div class="container-fluid">
            <div class="panel-body bordes_curvos" style="background-color: #f8f8f8">
                ...
                <div class="divCard tcentrado">
                    <h1 id="h1_titulo" runat="server" class="panel-title">&nbsp;&nbsp;Catálogo de Tratados</h1>
                </div>
                <dx:ASPxCallbackPanel ID="cbpCatTratados" runat="server" ClientInstanceName="cbpCatTratados" OnCallback="cbpCatTratados_Callback">
                    <PanelCollection>
                        <dx:PanelContent runat="server">
                            <asp:HiddenField ID="hdnGuardar" runat="server" ClientIDMode="Static" Value="0" />
                            <asp:HiddenField ID="hdnTratadoKey" runat="server" ClientIDMode="Static" />
                           
                            
                            <asp:LinkButton ID="lkb_Nuevo" runat="server" CssClass="btn btn-info btn-sm  btn-height" OnClientClick="EventosTratados('nuevoTratado')">
                                <span class="fa fa-plus"></span>&nbsp;Agregar
                            </asp:LinkButton>
                            <asp:LinkButton ID="lkb_Editar" runat="server" CssClass="btn btn-info btn-sm btn-height" OnClientClick="EventosTratados('editaTratado')">
                            ...
                            <dx:ASPxGridView ID="grvTratados" ClientInstanceName="gridT" runat="server" KeyFieldName="Tratado_Key"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="ID" FieldName="Tratado_Key" Visible="false" />
                                    <dx:GridViewDataTextColumn Caption="Clave" Width="30%" FieldName="Tratado_Clave" >
                                        <HeaderStyle HorizontalAlign="Center" CssClass="tit_grid" Font-Bold="true" />
                                    </dx:GridViewDataTextColumn>                                    
                                    <dx:GridViewDataTextColumn Caption="Descripción" Width="70%" FieldName="Tratado_Descripcion" >
                                        <HeaderStyle HorizontalAlign="Center" CssClass="tit_grid" Font-Bold="true" />
                                    </dx:GridViewDataTextColumn>
                            ...
                            <dx:ASPxGridViewExporter ID="Exporter" GridViewID="grvTratados" runat="server" PaperKind="A5" Landscape="true" />
                            <%--</div>--%>

                            <button id="btnNuevo" type="button" data-toggle="modal" data-target="#modalTratado" style="display: none;"></button>
                            <div class="modal fade" id="modalTratado" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                ...
                                <div class="modal-dialog  modal-sm " role="document">
                                    <div class="modal-content" style="height: 90px">
                                        <div class="alert alert-warning text-center" style="-webkit-box-shadow: 0 5px 15px rgba(0, 0, 0, .5); box-shadow: 0 5px 15px rgba(0, 0, 0, .5);">
                                            ...
                                            <hr />
                                            <asp:LinkButton ID="btnAceptarDel" runat="server" CssClass="btn btn-primary btn-sm txt-sm" data-dismiss="modal" OnClientClick="EventosTratados('borrarTratado')">
                ...
                <script src="../ScriptsSaci/catTratados.js"></script>
            </div>
        </div>
    </div>
