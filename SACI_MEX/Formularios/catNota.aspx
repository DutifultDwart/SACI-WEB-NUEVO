<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Formularios/Principal.Master" CodeBehind="catNota.aspx.cs" Inherits="SACI_MEX.Formularios.catNota" %>

<%@ Register Assembly="DevExpress.Web.v17.1, Version=17.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>

<asp:Content ID="contPrinc1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function EventosNota(s, e) {
            cpbNota.PerformCallback(s, '');
        }
        ...
        function Valida(s, e) {
            ...
            if (txtNota_Id.GetValue() == null) {
                var label = document.getElementById('<%=lblNota_Id.ClientID%>');
                label.style.color = "red";
                errores = true;
            }
            else {
            ...
            if (txtNota_Texto.GetValue() == null) {
                var label = document.getElementById('<%=lblNota_Texto.ClientID%>');
                label.style.color = "red";
                errores = true;
            }
            else {
            ...
            if (errores) {
                ...
                cpbNota.PerformCallback('guardar');
            }
        }
        ...
        <div class="container-fluid">
            <div class="panel-body bordes_curvos" style="background-color: #f8f8f8">
                <div class="divCard tcentrado">
                    <h1 id="h1_titulo" runat="server" class="panel-title">&nbsp;&nbsp;Catálogo de Notas</h1>
                </div>
                <dx:ASPxCallbackPanel ID="cpbNota" runat="server" ClientInstanceName="cpbNota" OnCallback="cpbNota_Callback">
                    <PanelCollection>
                        <dx:PanelContent runat="server">
                            ...
                            <asp:LinkButton ID="lkb_Nuevo" runat="server" CssClass="btn btn-info btn-sm  btn-height" OnClientClick="EventosNota('nuevo');return false;">
                                <span class="fa fa-plus"></span>&nbsp;Agregar
                            </asp:LinkButton>
                            <asp:LinkButton ID="lkb_Editar" runat="server" CssClass="btn btn-info btn-sm btn-height" OnClientClick="EventosNota('editar');return false;">
                            ...
                            <br />
                            <dx:ASPxGridView ID="grvNota" ClientInstanceName="gridT" runat="server" KeyFieldName="Notas_Key" Width="100%" AutoGenerateColumns="False" Settings-HorizontalScrollBarMode="Auto" Theme="DevEx" Styles-Cell-CssClass="grid_content"
                                ...
                                <Columns>
                                    <dx:GridViewDataTextColumn Caption="ID" FieldName="Notas_Key" Visible="false" />
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Nota_Id" Width="30%" FieldName="Nota_Id">
                                        <HeaderStyle HorizontalAlign="Center" CssClass="tit_grid" Font-Bold="true" />
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Nota_Texto" Width="30%" FieldName="Nota_Texto">
                                        <HeaderStyle HorizontalAlign="Center" CssClass="tit_grid" Font-Bold="true" />
                                    </dx:GridViewDataTextColumn>
                            ...
                            <dx:ASPxGridViewExporter ID="Exporter" GridViewID="grvNota" runat="server" PaperKind="A5" Landscape="true" />

                            <button id="btnNuevo" type="button" data-toggle="modal" data-target="#modalNota" style="display: none;"></button>
                            <div class="modal fade" id="modalNota" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                <div class="modal-dialog" role="document">

                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="model-title" runat="server" id="titNewNota">Nueva Nota</h4>
                                        </div>
                                        <div class="modal-body">
                                            <div class="form-group row">

                                                <div class="col-sm-6">
                                                    <asp:TextBox ID="TXT_NOTAS_Key" runat="server" Width="100%" Text="0" CssClass="control-text" Visible="false"></asp:TextBox>
                                                ...
                                                <div class="col-sm-6">
                                                    <div runat="server" id="DivNombreAcc">
                                                        <label id="lblNota_Id" runat="server" class="form-text">Nota_Id *</label>
                                                        <div class="form-group" style="position: relative; width: 100%; float: left;">
                                                            <div class="input-group">
                                                                <dx:ASPxTextBox ID="TXT_NOTA_Id" runat="server" Width="100%" CssClass="control-text" MaxLength="20" ClientInstanceName="txtNota_Id"></dx:ASPxTextBox>
                                                ...
                                                <div class="col-sm-8">
                                                    <div runat="server" id="Div1">
                                                        <label id="lblNota_Texto" runat="server" class="form-text">Nota_Texto *</label>
                                                        <div class="form-group" style="position: relative; width: 100%; float: left;">
                                                            <div class="input-group">
                                                                <dx:ASPxTextBox ID="TXT_NOTA_TEXTO" runat="server" Width="100%" CssClass="control-text" MaxLength="25" ClientInstanceName="txtNota_Texto"></dx:ASPxTextBox>
                                ...
                                <div class="modal-dialog  modal-sm " role="document">
                                    <div class="modal-content" style="height: 90px">
                                        <div class="alert alert-warning text-center" style="-webkit-box-shadow: 0 5px 15px rgba(0, 0, 0, .5); box-shadow: 0 5px 15px rgba(0, 0, 0, .5);">
                                            ...
                                            <hr />
                                            <asp:LinkButton ID="btnAceptarDel" runat="server" CssClass="btn btn-primary btn-sm txt-sm" data-dismiss="modal" OnClientClick="EventosNota('borrar');return false;">
