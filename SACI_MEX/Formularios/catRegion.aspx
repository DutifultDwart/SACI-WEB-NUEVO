<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Formularios/Principal.Master" CodeBehind="catRegion.aspx.cs" Inherits="SACI_MEX.Formularios.catRegion" %>
...
<asp:Content ID="contPrinc1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function EventosRegion(s, e) {
            cbpRegion.PerformCallback(s, '');
        }

        function UpdatePager(s, e) {
            //var value = document.getElementById("hdnGuardar").value;
            if (document.getElementById("hdnGuardar").value == "1") {
                document.getElementById('btnSucces').setAttribute('data-whatever', 'gagdas');
                document.getElementById('btnSucces').click();
            } else if (document.getElementById("hdnGuardar").value == "2") {
                document.getElementById('btnErrorUser').setAttribute('data-whatever', 'gagdas');
                document.getElementById('btnErrorUser').click();
            } else if (document.getElementById("hdnGuardar").value == "3") {
                document.getElementById('btnNuevo').setAttribute('data-whatever', 'gagdas');
                document.getElementById('btnNuevo').click();
            } else if (document.getElementById("hdnGuardar").value == "4") {
                document.getElementById('btnError').setAttribute('data-whatever', 'gagdas');
        ...
        function Valida(s, e) {
            ...
            if (txtRegion.GetValue() == null) {
                var label = document.getElementById('<%=lblRegion.ClientID%>');
                label.style.color = "red";
                errores = true;
            } else {
                var label = document.getElementById('<%=lblRegion.ClientID%>');
            ...
            if (errores) {
                ...
                cbpRegion.PerformCallback('guardar');
            }
        }
    </script>
        ...
        <div class="container-fluid">
            <div class="panel-body bordes_curvos" style="background-color: #f8f8f8">
                ...
                <div class="divCard tcentrado">
                    <h1 id="h1_titulo" runat="server" class="panel-title">&nbsp;&nbsp;Catálogo de Regiones</h1>
                </div>

                <dx:ASPxCallbackPanel ID="cbpRegion" runat="server" ClientInstanceName="cbpRegion" OnCallback="cbpRegion_Callback">
                    <PanelCollection>
                        <dx:PanelContent runat="server">
                            ...
                            <asp:LinkButton ID="lkb_Nuevo" runat="server" CssClass="btn btn-info btn-sm btn-height" OnClientClick="EventosRegion('nuevo');return false;">
                                <span class="fa fa-plus"></span>&nbsp;Agregar
                            </asp:LinkButton>

                            <asp:LinkButton ID="lkb_Editar" runat="server" CssClass="btn btn-info btn-sm btn-height" OnClientClick="EventosRegion('editar'); return false;">
                                <span class="fa fa-edit"></span>&nbsp;Editar
                            </asp:LinkButton>

                            <asp:LinkButton ID="lkb_Eliminar" runat="server" CssClass="btn btn-info btn-sm btn-height btn-width" OnClientClick="document.getElementById('btnQuestion').setAttribute('data-whatever', ''); document.getElementById('pModalQuestion').innerHTML = '¿Estás seguro(a) de eliminar la región?'; document.getElementById('btnQuestion').click(); return false;">
                            ...
                            <dx:ASPxGridView ID="grvRegion" ClientInstanceName="gridT" runat="server" KeyFieldName="Region_Key"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="ID" FieldName="Region_Key" Visible="false" />
                                    <dx:GridViewDataTextColumn Caption="Tratado" Width="30%" FieldName="Tratado">
                                        <HeaderStyle HorizontalAlign="Center" CssClass="tit_grid" Font-Bold="true" />
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Región" Width="70%" FieldName="Region">
                                        <HeaderStyle HorizontalAlign="Center" CssClass="tit_grid" Font-Bold="true" />
                                    </dx:GridViewDataTextColumn>

                                </Columns>
                                <SettingsAdaptivity AdaptivityMode="HideDataCellsWindowLimit" HideDataCellsAtWindowInnerWidth="800" AdaptiveDetailColumnCount="1" AllowOnlyOneAdaptiveDetailExpanded="True">
                            ...
                            <!-- Botones y modales están correctos -->

                            <dx:ASPxGridViewExporter ID="Exporter" GridViewID="grvRegion" runat="server" PaperKind="A5" Landscape="true" />
                            <%--</div>--%>

                            <button id="btnNuevo" type="button" data-toggle="modal" data-target="#modalRegion" style="display: none;"></button>
                            <div class="modal fade" id="modalRegion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                <div class="modal-dialog modal-md" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" runat="server" id="titNewRegion">Nueva Region</h4>
                                        </div>
                                        <div class="modal-body">
                                            <div class="form-group row">

                                                <div class="col-sm-6">
                                                    <asp:TextBox ID="TXT_REGION_Key" runat="server" Width="100%" Text="0" CssClass="control-text" Visible="false"></asp:TextBox>
                                                ...
                                                <div class="col-sm-6">
                                                    <div runat="server" id="DivNombreAcc">
                                                        <label id="lblRegion" runat="server" class="form-text">Región *</label>
                                                        <div class="form-group" style="position: relative; width: 100%; float: left;">
                                                            <div class="input-group">
                                                                <dx:ASPxTextBox ID="TXT_REGION" runat="server" Width="100%" CssClass="control-text" MaxLength="20" ClientInstanceName="txtRegion"></dx:ASPxTextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="modal-dialog  modal-sm " role="document">
                                    <div class="modal-content" style="height: 90px">
                                        <div class="alert alert-warning text-center" style="-webkit-box-shadow: 0 5px 15px rgba(0, 0, 0, .5); box-shadow: 0 5px 15px rgba(0, 0, 0, .5);">
                                            ...
                                            <hr />
                                            <asp:LinkButton ID="btnAceptarDel" runat="server" CssClass="btn btn-primary btn-sm txt-sm" data-dismiss="modal" OnClientClick="EventosRegion('borrar');return false;">
