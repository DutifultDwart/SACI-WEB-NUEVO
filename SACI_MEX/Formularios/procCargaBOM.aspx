<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Formularios/Principal.Master" CodeBehind="procCargaBOM.aspx.cs" Inherits="SACI_MEX.Formularios.procCargaBOM" %>
    ...
    <div class="container-fluid">
        <div class="panel-body bordes_curvos" style="background-color: #f8f8f8">
            ...
            <div class="divCard tcentrado">
                <h1 id="h2" runat="server" class="panel-title">&nbsp;&nbsp;Carga BOMS</h1>
            ...
            <dx:ASPxCallbackPanel ID="panelPrinc" runat="server" ClientInstanceName="cp2"
                ...
                <PanelCollection>
                    <dx:PanelContent runat="server">
                        ...
                        <dx:ASPxPageControl runat="server" ID="PageCargaBOM" Height="100%" Width="100%" ContentStyle-Border-BorderWidth="3px" ClientInstanceName="pagePrincipal"
                                                ...
                                                <div class="form-row" style="height: 350px">
                                                    <div class="col-sm-12 col-lg-12">
                                                        <div style="width: 100%">
                                                            ...
                                                            <dx:ASPxGridView ID="grvCargaBOM" ClientInstanceName="grvCm_cte" runat="server" KeyFieldName="Id"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <dx:GridViewDataTextColumn Caption="Código Producto" Width="130px" FieldName="CVE_PRODUCTO" VisibleIndex="3">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="tit_grid" Font-Bold="true" />
                                                                        <CellStyle CssClass="grid_content"></CellStyle>
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="PT_FRACCCION" Width="130px" FieldName="PT_FRACCCION" VisibleIndex="4">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="tit_grid" Font-Bold="true" />
                                                                        <CellStyle HorizontalAlign="Center" CssClass="grid_content"></CellStyle>
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="PT_VALOR" Width="130px" FieldName="PT_VALOR" VisibleIndex="5">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="tit_grid" Font-Bold="true" />
                                                                        <CellStyle HorizontalAlign="Center" CssClass="grid_content"></CellStyle>
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="PT_MONEDA" Width="130px" FieldName="PT_MONEDA" VisibleIndex="6">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="tit_grid" Font-Bold="true" />
                                                                        <CellStyle HorizontalAlign="Center" CssClass="grid_content"></CellStyle>
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="PT_UNIDAD" Width="130px" FieldName="PT_UNIDAD" VisibleIndex="6">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="tit_grid" Font-Bold="true" />
                                                                        <CellStyle HorizontalAlign="Center" CssClass="grid_content"></CellStyle>
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataDateColumn Caption="E_INICIO" Width="120px" FieldName="E_INICIO" VisibleIndex="7">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="tit_grid" Font-Bold="true" />
                                                                        <CellStyle HorizontalAlign="Center" CssClass="grid_content"></CellStyle>
                                                                    </dx:GridViewDataDateColumn>
                                                                    <dx:GridViewDataDateColumn Caption="E_FIN" Width="120px" FieldName="E_FIN" VisibleIndex="7">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="tit_grid" Font-Bold="true" />
                                                                        <CellStyle HorizontalAlign="Center" CssClass="grid_content"></CellStyle>
                                                                    </dx:GridViewDataDateColumn>
                                                                    <dx:GridViewDataTextColumn Caption="CVE_MATERIAL" Width="130px" FieldName="CVE_MATERIAL" VisibleIndex="8">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="tit_grid" Font-Bold="true" />
                                                                        <CellStyle CssClass="grid_content"></CellStyle>
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="CVE_CONSUMO" Width="130px" FieldName="CVE_CONSUMO" VisibleIndex="9">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="tit_grid" Font-Bold="true" />
                                                                        <CellStyle HorizontalAlign="Center" CssClass="grid_content"></CellStyle>
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="MP_UNIDAD" Width="130px" FieldName="MP_UNIDAD" VisibleIndex="10">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="tit_grid" Font-Bold="true" />
                                                                        <PropertiesTextEdit DisplayFormatString="{0:n7}" />
                                                                        <CellStyle CssClass="grid_content"></CellStyle>
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="CVE_FRACCION" Width="130px" FieldName="CVE_FRACCION" VisibleIndex="11">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="tit_grid" Font-Bold="true" />
                                                                        <%--<PropertiesTextEdit DisplayFormatString="{0:n7}" />--%>
                                                                        <CellStyle CssClass="grid_content"></CellStyle>
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="CVE_PRECIO_UNITARIO" Width="130px" FieldName="CVE_PRECIO_UNITARIO" VisibleIndex="12">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="tit_grid" Font-Bold="true" />
                                                                        <PropertiesTextEdit DisplayFormatString="{0:n7}" />
                                                                        <CellStyle CssClass="grid_content"></CellStyle>
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="MONEDA" Width="130px" FieldName="MONEDA" VisibleIndex="13">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="tit_grid" Font-Bold="true" />
                                                                        <CellStyle HorizontalAlign="Center" CssClass="grid_content"></CellStyle>
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="PROV_TAX_ID" Width="130px" FieldName="PROV_TAX_ID" VisibleIndex="13">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="tit_grid" Font-Bold="true" />
                                                                        <CellStyle HorizontalAlign="Center" CssClass="grid_content"></CellStyle>
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="CLIENTE_TAX_ID" Width="130px" FieldName="CLIENTE_TAX_ID" VisibleIndex="13">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="tit_grid" Font-Bold="true" />
                                                                        <CellStyle HorizontalAlign="Center" CssClass="grid_content"></CellStyle>
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="ORIGEN" Width="130px" FieldName="ORIGEN" VisibleIndex="13">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="tit_grid" Font-Bold="true" />
                                                                        <CellStyle HorizontalAlign="Center" CssClass="grid_content"></CellStyle>
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
